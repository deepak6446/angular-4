...
export class ListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.comments.push({'comments':'Everyone says it is a very good dish, so tasty. The recipe works very well. I have tried another one before which never worked well and is so complicated. Thanks a lot.'},{'date':'2017-12-27T12:53:03.332Z'}, {'by': 'ricky'})
    this.recipeData      = {
      "ingredients": [{'2 1/2' :'cm fresh ginger, peeled and coarsely chopped'}, {'8': 'garlic cloves, peeled'}, {'4': 'tablespoons water'}, {'10': 'tablespoons vegetable oil'},{'275 -425 ml': 'water'},{'1 kg': 'boneless lamb shoulder or 1 kg stewing beef or 1 kg diced chicken'},{'10' :'whole cardamom pods'},{'2 ':'bay leaves'},{'6 ':'whole cloves'},{'10 ':'whole peppercorns'},{'2 1⁄2 cm ':'cinnamon sticks'},{'4 ':'medium onions, peeled and finely chopped'},{'1 t':'easpoon ground coriander'},{'2 ':'teaspoons cumin seeds'},{'4 ':'teaspoons paprika'},{'1 ':'teaspoon cayenne pepper'},{'1 ':'teaspoon salt'},{'6 ':'tablespoons plain yogurt'},{'1⁄4 ':'teaspoon garam masala],'}], "image": "images/Rogan_Josh.jpg",
